...
private:
    ...
    static constexpr float Kp_left = 8.378; // Coefficient proportionnel pour le moteur gauche
    static constexpr float Ki_left = 92.071; // Coefficient intégral pour le moteur gauche
    static constexpr float Kp_right = 8.378; // Coefficient proportionnel pour le moteur droit
    static constexpr float Ki_right = 92.071; // Coefficient intégral pour le moteur droit
