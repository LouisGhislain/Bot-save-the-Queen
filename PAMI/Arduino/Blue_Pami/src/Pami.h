...
private:
    ...
    static constexpr float Kp_left = 45.813; // Coefficient proportionnel pour le moteur gauche
    static constexpr float Ki_left = 106.13; // Coefficient intégral pour le moteur gauche
    static constexpr float Kp_right = 45.813; // Coefficient proportionnel pour le moteur droit
    static constexpr float Ki_right = 106.13; // Coefficient intégral pour le moteur droit
