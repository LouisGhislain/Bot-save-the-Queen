...
<<<<<<< HEAD
    ...
    int32_t ticks_per_10µs = readData("speed");
    double speed = -(ticks_per_10µs / static_cast<double>(ENCODER_COUNTS_PER_REV))*10000*2*M_PI; // Speed in rad/s
=======
...
>>>>>>> e07ecbc0aceecc316639241ad2438a83a58c59eb
    return speed;
}
